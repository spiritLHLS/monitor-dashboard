...
<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="是否冻结" prop="isFrozen" width="120">
            <template #default="scope">{{ formatBoolean(scope.row.isFrozen) }}</template>
        </el-table-column>
          <el-table-column align="left" label="推送渠道1" prop="pushChannel1" width="120" />
          <el-table-column align="left" label="推送渠道2" prop="pushChannel2" width="120" />
          <el-table-column align="left" label="推送渠道3" prop="pushChannel3" width="120" />
          <el-table-column align="left" label="TGID" prop="tgID" width="120" />
          <el-table-column align="left" label="QQ号" prop="qqNumber" width="120" />
          <el-table-column align="left" label="微信号" prop="weChatNumber" width="120" />
          <el-table-column align="left" label="邮箱" prop="email" width="120" />
          <el-table-column align="left" label="备注" prop="additional" width="120" />
